...
class Quantity(EnumMixin, enum.Enum):
    ...
    ControlWriteThermometrie = "Control Thermometrie / Thermometrie "
    ...
    ControlWriteSettleTime = "Control Heating / settle time (mode controlled)"
    ControlWriteTimeoutTime = "Control Heating / timeout time (mode controlled)"
    StatusReadTemperatureBox = "Temperature HeaterBox / Temperature_C"
